...
![CrazyBee F4 DX Pro 正面](images/CrazyBeeF4DXProTop.jpg)
![CrazyBee F4 DX Pro 背面](images/CrazyBeeF4DXProBot.jpg)

## 描述

CrazyBee F4 DX Pro 是一款高度集成的飞控板（接收机、四合一 ESC、OSD、电流传感器），适用于 1-2S Whoop 无刷竞速四轴。
...
- 内置基于串行接口的 DSM2/DSMX 兼容卫星接收机（UART2 RX）
