...
1. numbered list item 3
   <br />A coded break is to separate text from ordered lists
...
$$
$$
\nabla \times \vec{\mathbf{E}} = - \frac{\partial \vec{\mathbf{B}}}{\partial \mathrm{t}}
$$
$$
\nabla \times \vec{\mathbf{B}} = \mu_0 \left( \vec{\mathbf{J}} + \epsilon_0 \frac{\partial \vec{\mathbf{E}}}{\partial \mathrm{t}} \right)
$$
...
The `<Plot>` component enables high-quality data visualizations.
See the [**full documentation**](./Plot-Component) for details.
